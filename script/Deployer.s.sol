...
contract TokenAndPoolDeployer is Script{
    ...
    function deployTokenAndPool(Register.NetworkDetails memory _networkDetails) public returns(RebaseToken token, RebaseTokenPool pool){
        ...
        RegistryModuleOwnerCustom registryModuleOwnerCustom = RegistryModuleOwnerCustom(_networkDetails.registryModuleOwnerCustomAddress); 
       ...
       registryModuleOwnerCustom.registerAdminViaGetCCIPAdmin(address(token));
