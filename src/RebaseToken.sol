...
contract RebaseToken is ERC20, Ownable, AccessControl {
    ...
    uint256 private s_interestRate = (5 * PRECISION) / 1e8; // 0.000005% per second global interest rate.
     ...
     * @param _interestRate - the interest rate we want to set
     */
    ...
    /**
     * @notice the owner can grant the mint and burn role
     * @param _account the address we want to give the burn and mint role to.
     */
    ...
    function _calculateUserAccumulatedInterestSinceLastUpdate(address user)
        internal
        view
        returns (uint256 _accumulatedLinearInterest)
    {
